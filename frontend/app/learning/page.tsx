    ...
    <PageWrapper>
      ...
      <section className="bg-radial-red p-16 text-center">
        <div className="mx-auto max-w-[900px]">
          ...
          {/* MCP Explanation */}
          <div className="mx-auto max-w-[700px] rounded-lg border border-primary-red/20 bg-black/30 p-6 text-left">
            <h3 className="mb-3 text-lg font-semibold text-primary-red">How MCP Generates Learning Logs</h3>
            ...
            <ul className="mb-3 space-y-2 text-sm text-text-light">
